                                ...
                                <div class="ibox-body">
                                    ...
                                    <table class="table table-striped m-t-20 visitors-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/us.png')}}" />USA</td>
                                                <td>755</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/Canada.png')}}" />Canada</td>
                                                <td>700</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/India.png')}}" />India</td>
                                                <td>410</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/Australia.png')}}" />Australia</td>
                                                <td>304</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/Singapore.png')}}" />Singapore</td>
                                                <td>203</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/uk.png')}}" />UK</td>
                                                <td>202</td>
                                                <td>
                                                    <div class="progress">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="m-r-10" src="{{ asset('assets/img/flags/UAE.png')}}" />UAE</td>
                                                <td>180</td>
                                                <td>
                                                    <div class="progress">
                                ...
                                <div style="flex:1;">
                                    <div class="d-flex justify-content-end wrap-3">
                                        <div class="adminca-banner-b m-r-20">
                                            <img src="{{asset('assets/img/adminca-banner/bootstrap.png')}}" style="width:40px;margin-right:10px;" />Bootstrap v4</div>
                                        <div class="adminca-banner-b m-r-10">
                                            <img src="{{asset('assets/img/adminca-banner/angular.png')}}" style="width:35px;margin-right:10px;" />Angular v5+</div>
                                    </div>
                                    <div class="dev-img">
